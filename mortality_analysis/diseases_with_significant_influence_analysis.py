...
class DiseaseInfluence:
    ...
    def analyze_and_visualize(self):
        ...
        correlations = self.data[diseases_of_interest + ['Total Deaths']].corr()['Total Deaths'].drop('Total Deaths')
